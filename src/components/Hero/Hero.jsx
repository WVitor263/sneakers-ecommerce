      ...
      <div className="hero-text">
        ...
        <div className="product-actions">
          <div className="quantity-selector">
            <button className="menus-and-plus" onClick={decrementQty}>
              <img src={iconsMinus} alt="icon Minus" />
            </button>
            <span className="quantity">{qty}</span>
            <button className="menus-and-plus" onClick={incrementQty}>
              <img src={iconsPlus} alt="icon Plus" />
            </button>
          </div>
